...
{
    public class StoreDynamicPropertyObjectValueEntity : AuditableEntity
    {
        [StringLength(256)]
        ...
        public virtual StoreDynamicPropertyObjectValueEntity FromModel(DynamicPropertyObjectValue propValue, IHasDynamicProperties owner, DynamicProperty dynamicProperty)
        {
            if (propValue == null)
            {
                throw new ArgumentNullException(nameof(propValue));
            ...
            StoreId = propValue.ObjectId ?? owner.Id;
        ...
        public virtual void Patch(StoreDynamicPropertyObjectValueEntity target)
        {
