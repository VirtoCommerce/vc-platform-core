angular.module('virtoCommerce.paymentModule').controller('virtoCommerce.paymentModule.paymentMethodListController', ['$scope', 'platformWebApp.bladeNavigationService', function ($scope, bladeNavigationService) {
    ...
    $scope.selectNode = function (node) {
        ...
        var newBlade = {
            ...
            subtitle: 'payment.blades.paymentMethod-detail.subtitle',
