...
namespace VirtoCommerce.LicensingModule.Data.Handlers
{
    public class LogLicenseChangedEventHandler : IEventHandler<LicenseSignedEvent>, IEventHandler<LicenseChangedEvent>
    {
        ...
        public async Task Handle(LicenseSignedEvent message)
        {
        ...
        protected virtual Task SaveOperationLogAsync(string objectId, string detail, EntryState entryState)
        {
            ...
            return _changeLogService.SaveChangesAsync(operation);
        }
