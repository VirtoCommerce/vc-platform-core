...
var fakeJournal = {"notifications":[
                                    {"id":"5c88b339b9c84bcbbb5bbc483ddc1f48",
                                     "displayName":"New subscription notification",
                                     "description":"This notification sends by email to client when created new subscription",
                                     "isEmail":true,
                                     "isSms":false,
                                     "type":"NewSubscriptionEmailNotification",
                                     "isActive":true,
                                     "isSuccessSend":false,
                                     "objectTypeId":"Subscription",
                                     "language":"en-US",
                                     "sendingGateway":"DefaultSmtpEmailNotificationSendingGateway",
                                     "subject":"You are successfully subscribed to new subscription <strong> SU180131-00001 </strong>",
                                     "body":"Subscription SU180131-00001 with amount 290.94USD successfully created.",
                                     "sender":"noreply@mail.com",
                                     "recipient":"test@ke.com",
                                     "attemptCount":1,
                                     "maxAttemptCount":10,
                                     "lastFailAttemptMessage":"The SMTP host was not specified.",
                                     "lastFailAttemptDate":"2018-01-31T07:49:01.037Z",
                                     "startSendingDate":"2018-01-01T07:49:01.037Z"}
                                    ,{"id":"277fbec3db7247e5be5c206ff8f96be8","displayName":"Registration notification","description":"This notification is sent by email to a client when he finishes registration","isEmail":true,"isSms":false,"type":"RegistrationEmailNotification","isActive":true,"isSuccessSend":true,"objectId":"Electronics","objectTypeId":"Store","language":"en-US","sendingGateway":"DefaultSmtpEmailNotificationSendingGateway","subject":"Your login - test.","body":"Thank you for registration  !!!","sender":"noreply@mail.com","recipient":"test@ke.com","attemptCount":1,"maxAttemptCount":10,"lastFailAttemptMessage":"The SMTP host was not specified.","lastFailAttemptDate":"2018-01-31T07:46:00.75Z", "startSendingDate":"2018-01-01T07:49:01.037Z"}],"totalCount":2};
...
angular.module('virtoCommerce.notificationsModule')
  ...
  function notificationsService(searchCriteria) {
      ...
      self.getNotificationJournalDetails = function(id) {
          return fakeHttpCall(true).then(
            function(data) {
                return _.findWhere(fakeJournal.notifications, { id: id.id });
            },
            function(err) {
                // error callback
                console.log(err)
